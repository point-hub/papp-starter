...
const {
  ...
  columns: {
    ...
    operation_id: { label: 'Operation ID', isVisible: true, isSelectable: true },
    ...
    module: { label: 'Module', isVisible: true, isSelectable: false },
    entity_type: { label: 'Entity Type', isVisible: false, isSelectable: true },
    entity_id: { label: 'Entity ID', isVisible: false, isSelectable: true },
    entity_ref: { label: 'Entity', isVisible: true, isSelectable: false },
